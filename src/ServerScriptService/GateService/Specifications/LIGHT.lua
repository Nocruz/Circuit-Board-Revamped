...
return {
	...
	Setup = function(self, state)
		...
		Updates.RegisterVisualChange(self.Model.Top, { PointLight = { Color = self.InternalState.Color, Enabled = self.InternalState.Color ~= Color3.new() }, Color = self.InternalState.Color })
	end,
